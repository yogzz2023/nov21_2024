...
class KalmanFilterGUI(QWidget):
    ...
    def initUI(self):
        ...
        self.plot_tab.layout().addWidget(self.plot_type_label)
        self.plot_tab.layout().addWidget(self.plot_type_combo)
        ...
        self.plot_tab.layout().addWidget(self.plot_color_label)
        self.plot_tab.layout().addWidget(self.plot_color_combo)
        ...
        self.plot_tab.layout().addWidget(self.plot_config_button)
    ...
    def show_plot_config_dialog(self):
